...
const Navbar = () => {
  const [firstName, setFirstName] = useState("") // Update firstName and lastName to user
  ...
  // Temporary disable; once user is logged in, enable specific components on navbar such as the buttons for
  //                    fuel quote form, history, and profile; else disable them
  ...
  return (
    <div className='flex h-15 px-4 fixed top-0 z-40 bg-none w-full'>
        <div className='flex justify-start items-center w-full'>
            <div className='flex items-center cursor-pointer mr-4 hover:drop-shadow-lg' onClick={()=>{window.location.replace('/')}}>
            ...
            <ul className='flex'>
                ...
                <li>
                    <Typography variant="h4" className="text-center cursor-pointer hover:text-blue-600" onClick={()=>{window.location.replace('/history')}}>History</Typography>
                </li>
            </ul>
        </div>
        ...
        <div className='flex justify-end items-center w-full'>
            <Typography variant="h4" className="text-center px-2 text-blue-600">{firstName + " " + lastName}</Typography>
            <Menu>
                <MenuHandler>
                    <IconButton className="border-none bg-transparent shadow-none">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 16 16"
                ...
                <MenuList>
                    <MenuItem className="flex items-center gap-2 border-none" onClick={()=>{window.location.replace('/profile')}}>
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                    ...
                    <MenuItem className="flex items-center gap-2 border-none" onClick={handleLogout}>
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
